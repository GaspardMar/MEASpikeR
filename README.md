...
## If the package is available on gitlab, you can install it and load it like that 

# for installing the devtools package necessary to install a package available on gitlab
...
Data are generated automatically from recordings. **These files consist of “frequency” and “spike” CSV files that, for the use of the package, need to be stored in the same folder called “data”.** This is a view of the `\data` folder without the guideline (we will explain how to create it in the next paragraph):
