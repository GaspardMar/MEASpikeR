...
#' @param filt.data.path Path to the "MEA_DATAFILTERED.Rdat" file generated
#' by the \code{dataset_filtering} function.
#' @param output_directory Character specifying the directory where we want to save the output pdf file
...
#' \code{wesanderson} and \code{RColorBrewer} packages.
