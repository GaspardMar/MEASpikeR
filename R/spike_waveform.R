...
#' @param filt.data.path Path to "MEA_DATA2ANALYZE.Rdat" file generated
#' by the \code{dataset_filtering} function
#' @param working_directory Character specifying the working directory where you want to save the output folder
